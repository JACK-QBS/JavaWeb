...
<head>
    <title>注册</title>
    <h1 style="color: deepskyblue">注册</h1>
    <style >
        body{
            text-align: center;
            margin-top: 100px;
...
<body>
    <form action="/regist.jsp " method="post">
                ...
                <input type="checkbox" name="favorite" value="fitness"> 健身 &nbsp;</br>
                <input type="checkbox" name="favorite" value="home"> 家居 &nbsp;
                <input type="checkbox" name="favorite" value="cate"> 美食 &nbsp;</br></br>
